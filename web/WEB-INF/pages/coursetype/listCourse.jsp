...
<s:form action="courseTypeAction_findAll.action" name="/">
	<s:hidden name="pageNum" id="pageNum" value="1"/>
	<table width="88%" border="0" class="emp_table" style="width:80%;">
	  ...
	  <tr>
	    <td>课程费用：</td>
	    <td ><s:textfield name="%{'courseCostStart'}" size="12"/>至<s:textfield name="%{'courseCostEnd'}" size="12"/></td>
	  </tr>
	</table>
</s:form>
